...
def settingsMenu():
    ...
    layout = [[sg.Text('Camera', font=layoutFont), sg.In(getSettingsValues[0], font=layoutFont)],
              [sg.Text('User ID', font=layoutFont), sg.In(getSettingsValues[1], font=layoutFont)],
              [sg.Text('Authorization Key', font=layoutFont), sg.In(getSettingsValues[2], font=layoutFont)],
